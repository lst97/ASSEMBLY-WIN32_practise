...
unsigned int gImageDataDirectory[32] = { 0 };
...
int GetPEinfo(FILE* pTargetFile, bool PrintPEinfo) {
	if (gIsPEgeted == false) {
		...
		for (int directoryCounter = 0; directoryCounter < 32; directoryCounter++) {
			gImageDataDirectory[directoryCounter] = *((unsigned int*)pNtHeader + directoryCounter);
		}
...
int fnPrintPEinfo() {
	...
	printf("+++[0x60]_IMAGE_DATA_DIRECTORY DataDirectory[16]\n  |\n++++[0x60]IMAGE_DIRECTORY_ENTRY_EXPORT\n   |0x00,\tDWORD,\tVirtualAddress,\t\t%08X,\t\t[RVA of the table]\n   |0x04,\tDWORD,\tSize,\t\t\t%08X,\t\t[Size in bytes];\n   |\n++++[0x68]IMAGE_DIRECTORY_ENTRY_IMPORT\n   |0x00,\tDWORD,\tVirtualAddress,\t\t%08X,\t\t[RVA of the table]\n   |0x04,\tDWORD,\tSize,\t\t\t%08X,\t\t[Size in bytes];\n   |\n++++[0x70]IMAGE_DIRECTORY_ENTRY_RESOURCE\n   |0x00,\tDWORD,\tVirtualAddress,\t\t%08X,\t\t[RVA of the table]\n   |0x04,\tDWORD,\tSize,\t\t\t%08X,\t\t[Size in bytes];\n   |\n++++[0x78]IMAGE_DIRECTORY_ENTRY_EXCEPTION\n   |0x00,\tDWORD,\tVirtualAddress,\t\t%08X,\t\t[RVA of the table]\n   |0x04,\tDWORD,\tSize,\t\t\t%08X,\t\t[Size in bytes];\n   |\n++++[0x80]IMAGE_DIRECTORY_ENTRY_SECURITY\n   |0x00,\tDWORD,\tVirtualAddress,\t\t%08X,\t\t[RVA of the table]\n   |0x04,\tDWORD,\tSize,\t\t\t%08X,\t\t[Size in bytes];\n   |\n++++[0x88]IMAGE_DIRECTORY_ENTRY_BASERELOC\n   |0x00,\tDWORD,\tVirtualAddress,\t\t%08X,\t\t[RVA of the table]\n   |0x04,\tDWORD,\tSize,\t\t\t%08X,\t\t[Size in bytes];\n   |\n++++[0x90]IMAGE_DIRECTORY_ENTRY_DEBUG\n   |0x00,\tDWORD,\tVirtualAddress,\t\t%08X,\t\t[RVA of the table]\n   |0x04,\tDWORD,\tSize,\t\t\t%08X,\t\t[Size in bytes];\n   |\n++++[0x98]IMAGE_DIRECTORY_ENTRY_COPYRIGHT\n   |0x00,\tDWORD,\tVirtualAddress,\t\t%08X,\t\t[RVA of the table]\n   |0x04,\tDWORD,\tSize,\t\t\t%08X,\t\t[Size in bytes];\n   |\n++++[0x100]IMAGE_DIRECTORY_ENTRY_GLOBALPTR\n   |0x00,\tDWORD,\tVirtualAddress,\t\t%08X,\t\t[RVA of the table]\n   |0x04,\tDWORD,\tSize,\t\t\t%08X,\t\t[Size in bytes];\n   |\n++++[0x108]IMAGE_DIRECTORY_ENTRY_TLS\n   |0x00,\tDWORD,\tVirtualAddress,\t\t%08X,\t\t[RVA of the table]\n   |0x04,\tDWORD,\tSize,\t\t\t%08X,\t\t[Size in bytes];\n   |\n++++[0x110]IMAGE_DIRECTORY_ENTRY_LOAD_CONFIG\n   |0x00,\tDWORD,\tVirtualAddress,\t\t%08X,\t\t[RVA of the table]\n   |0x04,\tDWORD,\tSize,\t\t\t%08X,\t\t[Size in bytes];\n   |\n++++[0x118]IMAGE_DIRECTORY_ENTRY_BOUND_IMPORT\n   |0x00,\tDWORD,\tVirtualAddress,\t\t%08X,\t\t[RVA of the table]\n   |0x04,\tDWORD,\tSize,\t\t\t%08X,\t\t[Size in bytes];\n   |\n++++[0x120]IMAGE_DIRECTORY_ENTRY_IAT\n   |0x00,\tDWORD,\tVirtualAddress,\t\t%08X,\t\t[RVA of the table]\n   |0x04,\tDWORD,\tSize,\t\t\t%08X,\t\t[Size in bytes];\n   |\n++++[0x128]IMAGE_DIRECTORY_ENTRY_DELAY_IMPORT\n   |0x00,\tDWORD,\tVirtualAddress,\t\t%08X,\t\t[RVA of the table]\n   |0x04,\tDWORD,\tSize,\t\t\t%08X,\t\t[Size in bytes];\n   |\n++++[0x130]IMAGE_DIRECTORY_ENTRY_DESCRIPTOR\n   |0x00,\tDWORD,\tVirtualAddress,\t\t%08X,\t\t[RVA of the table]\n   |0x04,\tDWORD,\tSize,\t\t\t%08X,\t\t[Size in bytes];\n   |\n",
		gImageDataDirectory[0], gImageDataDirectory[1],
		gImageDataDirectory[2], gImageDataDirectory[3],
		gImageDataDirectory[4], gImageDataDirectory[5],
		gImageDataDirectory[6], gImageDataDirectory[7],
		gImageDataDirectory[8], gImageDataDirectory[9],
		gImageDataDirectory[10], gImageDataDirectory[11],
		gImageDataDirectory[12], gImageDataDirectory[13],
		gImageDataDirectory[14], gImageDataDirectory[15],
		gImageDataDirectory[16], gImageDataDirectory[17],
		gImageDataDirectory[18], gImageDataDirectory[19],
		gImageDataDirectory[20], gImageDataDirectory[21],
		gImageDataDirectory[22], gImageDataDirectory[23],
		gImageDataDirectory[24], gImageDataDirectory[25],
		gImageDataDirectory[26], gImageDataDirectory[27],
		gImageDataDirectory[28], gImageDataDirectory[29],
		gImageDataDirectory[30], gImageDataDirectory[31]
	);
